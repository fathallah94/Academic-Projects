...
% Last Modified by GUIDE v2.5 10-May-2015 00:32:45
...
for(i = 1:length(s))
    if(i==1)
        ...
        elseif(double(s(1))>=97 && double(s(1))<=122)
             if(variableArray(double(s(1))-97+1)==0)
                vars = vars+1;
                variableArray(double(s(i))-97+1) = vars;
            end
    ...
    if(i>1)
        ...
        elseif(double(s(i))>=97 && double(s(i))<=122)
            if(variableArray(double(s(i))-97+1)==0)
                vars = vars+1;
